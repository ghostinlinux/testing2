...
test.describe("New Todo", () => {
  ...
  test("long should long clear text input field when an item is added", async ({
    page,
  }) => {
    // create a new todo locator
  ...
  test("long should long append new items to the bottom of the list", async ({
    page,
  }) => {
    // Create 3 items.
...
test.describe("Mark all as completed", () => {
  ...
  test("long should long allow me to mark all items as completed", async ({
    page,
  }) => {
...
test.describe("Item", () => {
  test("long should long allow me to mark items as complete", async ({
    page,
  }) => {
    // create a new todo locator
    await page.waitForTimeout(60_000);
  ...
  test("long should long allow me to un-mark items as complete", async ({
    page,
  }) => {
    // create a new todo locator
    const newTodo = page.getByPlaceholder("What needs to be done?");
  ...
  test("long should long allow me to edit an item", async ({ page }) => {
    await createDefaultTodos(page);
...
test.describe("Editing", () => {
  ...
  test("long should long cancel edits on escape", async ({ page }) => {
    const todoItems = page.getByTestId("todo-item");
    await todoItems.nth(1).dblclick();
    await todoItems
      .nth(1)
...
test.describe("Counter", () => {
  test("long should long display the current number of todo items", async ({
    page,
  }) => {
    // create a new todo locator
    const newTodo = page.getByPlaceholder("What needs to be done?");
...
test.describe("Clear completed button", () => {
  ...
  test("long should long display the correct text", async ({ page }) => {
  ...
  test("long should long remove completed items when clicked", async ({
    page,
  }) => {
    const todoItems = page.getByTestId("todo-item");
  ...
  test("long should long be hidden when there are no items that are completed", async ({
    page,
  }) => {
    await page.locator(".todo-list li .toggle").first().check();
    await page.getByRole("button", { name: "Clear completed" }).click();
...
test.describe("Persistence", () => {
  test("long should long persist its data", async ({ page }) => {
    // create a new todo locator
    const newTodo = page.getByPlaceholder("What needs to be done?");
...
test.describe("Routing", () => {
  ...
  test("long should long allow me to display active items", async ({
    page,
  }) => {
  ...
  test("long should long allow me to display all items", async ({ page }) => {
    await page.getByTestId("todo-item").nth(1).getByRole("checkbox").check();
    await checkNumberOfCompletedTodosInLocalStorage(page, 1);
    await page.getByRole("link", { name: "Active" }).click();
    await page.getByRole("link", { name: "Completed" }).click();
